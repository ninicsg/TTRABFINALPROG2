...
function GerenciarClientes() {
  ...
  async function handleAdicionar(e) {
    ...
    if (!clienteAtual.senha) {
        alert("O campo Senha é obrigatório.");
        return;
    }

    try {
      await api.post("/homeadmin/gerenciarclientes", clienteAtual);
      ...
      let mensagemErro = "Erro ao adicionar cliente. Verifique os dados.";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form onSubmit={modoEdicao ? handleEditar : handleAdicionar}>
            <div
              style={{
                display: "grid",
